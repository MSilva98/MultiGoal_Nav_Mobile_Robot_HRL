...
class agentController():
    ...
    def run(self):
        ...
        if maze == 1:
            ...
            avg_lowLvl = "avgLowLvlTimes_maze1.txt"
            visitedStates_file = open("visited_states_maze1.txt", "w+")
        else:
            # MAZE 2
            self.highLevel = highLvlAgent(alpha=0.3, gamma=0.99, episodes=200, epsilon=0.3, statesFile="maze2.txt")
            ...
            avg_lowLvl = "avgLowLvlTimes_maze2.txt"
            visitedStates_file = open("visited_states_maze2.txt", "w+")
        ...
        while self.robot.step(self.timestep) != -1:     
            ...
            if self.highLevel.reachedGoal((cur_pos[0], cur_pos[2], cur_ori)):
                ...
                if next_State != '':
                    ...
                    print((cur_pos[0], cur_pos[2], cur_ori))
                    break
        ...
        # json.dump(visited_states, visitedStates_file)
