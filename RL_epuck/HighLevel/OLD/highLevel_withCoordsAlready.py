...
class Agent():
    ...
    def getState(self, state, checkingGoal=False):
        ...
        #                       all_states.append(str((round(x+i/100,2), round(z+j/100,2), round(ori+(l*math.pi/180),2))))
        ...
        # If checking for goal position consider square area of 6x6
        if checkingGoal:
            for i in range(-6,7):
                for j in range(-6,7):
                    all_states.append(str((round(x+i/100,2),round(z+j/100,2))))
        ...
        # if not checkingGoal:
        #     if x < 1.2 and x > 1.1 and z > -0.55 and z < -0.45:
        #         print("\n\nNEW ITERATION")
        #         print(all_states)
        #         print(self.QTable.keys())

        #     if x < 1.2 and x > 1.1 and z > -0.25 and z < -0.15:
        #         print("\n\nNEW ITERATION")
        #         print(all_states)
        #         print(self.QTable.keys())

        #     if x < 0.7 and x > 0.6 and z > -0.55 and z < -0.45:
        #         print("\n\nNEW ITERATION")
        #         print(all_states)
        #         print(self.QTable.keys())

        #     if x < 0.7 and x > 0.6 and z > -0.25 and z < -0.15:
        #         print("\n\nNEW ITERATION")
        #         print(all_states)
        #         print(self.QTable.keys())
    ...
    def updateQTable(self, cur_state, next_state, action, timePassed):
        ...
        # print("STATE:", cur_state, " N STATE:", next_state, "ACTIONS: ", self.QTable[cur_state], " Action:", action, " RWD:", rwd)
