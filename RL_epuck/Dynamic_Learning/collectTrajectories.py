...
class agentController():
    ...
    def run(self):
        ...
        if maze == 1:
            ...
            # MAZE 2
            self.highLevel = highLvlAgent(epsilon=0, statesFile="./mazes/maze2.txt", Qtable="QTable_HighLevel_maze2_updated_2.txt")
            ...
            name = "maze2_trajectory_updated_2.txt"
        ...
        while self.robot.step(self.timestep) != -1:    
            ...
            if corridor:
                ...
                if highState != '':
                    ...
                    print("DOOR:", self.highLevel.statesNames[highState], "S:", highState, "P:", (cur_pos[0], cur_pos[2], cur_ori), "A:", highAction)
                    if highAction == "right":
                        right = True
                        left  = False
                        front = False
