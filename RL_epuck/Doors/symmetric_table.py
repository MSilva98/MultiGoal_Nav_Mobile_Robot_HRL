...
# originalTable = open("./v5/QTable_v5_17500h_LR_Right_v2.txt", "r")
# symmetricTable = open("./v5/QTable_v5_17500h_LR_Left_v2.txt", "w+")

# originalTable = open("../LowLevelCombined/QTable_Right_Door.txt", "r")
# symmetricTable = open("../LowLevelCombined/QTable_Left_Door.txt", "w+")

# originalTable = open("./lr/QTable_v5_13000h_LR_Right.txt", "r")
# symmetricTable = open("./lr/QTable_v5_13000h_LR_Left.txt", "w+")
...
originalTable = open("./v52/QTable_right.txt", "r")
symmetricTable = open("./v52/QTable_left.txt", "w+")
