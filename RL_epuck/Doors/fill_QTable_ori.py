...
class fill_QTable():
    ...
    def run(self):
        ...
        z_vals_lr = [z/100 for z in range(-11, 35)]  # Inside LR Door
        z_vals_fwd_lr = [z/100 for z in range(22, 35)]
        ...
        rot_vals_lr = [rot*math.pi/180 for rot in range(90, -90, -1)]   # Used in LR Door

        # Load corridor QTable
        # f = open("../Corridor/QTable_v6_walls_2_8500h.txt", "r")
        f = open("../Corridor/QTable_v5_19500h.txt", "r")
        ...
        for door in doorTypes:
            if door == "FR":
                ...
                actions = ["Front"]      
            for act in actions:
                f2 = open("./LOGS/QTABLE_LOG_"+door+"_"+act+".txt", "w+")
                ...
                self.brain.saveQTable("./v5/QTable_v5_"+door+"_"+act+".txt")
                # self.brain.saveQTable("./v6/QTable_v6_"+door+"_"+act+".txt")
                print("TABLE SAVED!")
