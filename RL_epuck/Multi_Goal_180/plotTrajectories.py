...
def plotTrajectories(name):
    ...
    if name == "maze1_trajectory":
        ...
        college = Rectangle((-128.5,46),27,30,linewidth=1,edgecolor='g',facecolor='g',label="College")
        restaurant = Rectangle((-80,-128),27,26,linewidth=1,edgecolor='b',facecolor='b',label="Restaurant")
